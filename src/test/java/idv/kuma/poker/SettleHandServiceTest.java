...
public class SettleHandServiceTest {
    ...
    @Test
    void should_retrieve_hand_settle_it_and_save_back() throws EntityExistsException, PersistenceException {
    ...
    private void given_wallet(String playerId, long initialBalance) throws EntityExistsException, PersistenceException {
